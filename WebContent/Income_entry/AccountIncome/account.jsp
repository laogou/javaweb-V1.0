...
<%@ page import="java.sql.*,java.util.List,java.util.ArrayList,
    com.itheima.Dao.Outkind.Outkind,com.itheima.Dao.Outkind.OutkindDao,
    com.itheima.Dao.Outkind.OutkindDaoImpl,com.itheima.utils.DbUtils" %>
...
<center>
<form action="${pageContext.request.contextPath }/AddOutkindServlet" method="post">
			...
			<tr>
				...
				<td>
					...
					//加载数据库驱动
						...
						{
							%>
							<option value="<%=rs3.getString("outkind_name")%>"><%=rs3.getString("outkind_name")%></option>
							<%
						}
