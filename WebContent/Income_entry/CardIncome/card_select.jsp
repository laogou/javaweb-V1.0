...
<form action="${pageContext.request.contextPath }/CardSelectServlet" methond="post">
	<center>
		<table align="center">
		    <tr>
			...
			<tr>
		        <td>录入月份：</td><td><input type="date" name="cz_month" value="yyyy-mm-dd" /></td>
		    </tr>
			<tr>
				<td>城市编码：</td>
				<td>
			...
			<tr>
				<td>面值金额：</td><td><input type="text" name="card_price" /></td>
			</tr>
			<tr>
				<td>卡总金额：</td><td><input type="text" name="card_amount" /></td>
			</tr>
			<tr>
