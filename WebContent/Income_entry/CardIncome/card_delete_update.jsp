...
<span style="font-size: small;">
	...
	<center>
				<table border="1" align="center">
					...
					{
					%>
					<tr><td colspan="10"><font color="red">没有符合条件的数据</font></td></tr>
					<%
					}else{
						for(Card card:cards){
							%>
							...
							onclick="QuerryUserFrom.action='GetCardServlet?serial=<%=card.getSerial() %>';QuerryUserFrom.submit()">
							<input  type="submit" value="删除" 
							onClick= "QuerryUserFrom.action='CardDeleteServlet?serial=<%=card.getSerial() %>';QuerryUserFrom.submit()"></td>
							</tr> 
							<%
						}
					}
