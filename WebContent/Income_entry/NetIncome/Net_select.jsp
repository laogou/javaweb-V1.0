...
<form action="${pageContext.request.contextPath }/NetSelectServlet" method="post">
	<center>
		<table align="center">
		    <tr>
			...
			<tr>
				<td>录入日期：</td><td><input type="Date" name="date" value="yyyy-mm-dd" /></td>
			</tr>
			<tr>
				<td>城市编码：</td>
				<td>
