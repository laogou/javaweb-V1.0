...
<form action="${pageContext.request.contextPath }/SelectNoticeServlet" method="post">
	<center>
		<table align="center">
		    <tr>
		    ...
		    <tr>
		        <td>营业收款日期：</td><td><input type="date" name="cz_month"  /></td>
		    </tr>
			<tr>
				<td>城市编码：</td>
				<td>
			...
			<tr>
				<td>营业收入金额：</td><td><input type="text" name="input_money" /></td>
			</tr>
			<tr>
			...
			<tr>
				<table border="1" align="center">
					<tr>
						...
						<th align="center" bgcolor="cadetblue" width="100">营业收入录入金额</th>
					...
					<%
						...
						for(Notice notice:notices){
							%>
							<tr>
							<td><%=notice.getSerial() %></td>
							<td><%=notice.getDate() %></td>
							<td><%=notice.getCity_code() %></td>
							<td><%=notice.getProduct_code() %></td>
							<td><%=notice.getNotice_code() %></td>
							<td><%=notice.getAmount() %></td>
							<td><%=notice.getState() %></td>
							</tr>
							<%
						}
					}
