...
<center>
  <form action="CardCollectSerchServlet" method="post" onSubmit="return checkTime(document.getElementById('from').value,document.getElementById('to').value)">
  <%
...
<center>
    ...
    <%
      ...
      int iNum;
      try{
         cardList = (ArrayList<CardG>)request.getSession().getAttribute("cardList");
      ...
      %>
       <tr>
        ...
        <input name="checkOverName" value="数据归集完毕" type="submit" onClick="return checkOver()"/>
        </td>
      </tr>
      <%
      }catch(Exception e){
