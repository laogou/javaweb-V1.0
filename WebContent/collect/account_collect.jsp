...
<center>
  <form action="AccountCollectSerchServlet" method="post" onSubmit="return checkTime(document.getElementById('from').value,document.getElementById('to').value)">
  <%
...
<center>
    ...
    <%
      ...
      int iNum;
      try{
         accountList = (ArrayList<AccountG>)request.getSession().getAttribute("accountList");
